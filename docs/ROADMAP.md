...
**Objective:** Close the twelve deductions in the 2026-09-22 seminar grade report (84/100; never committed -- `docs/grade-reports/2026-09-23-seminar-grade-report.md` is the later 86/100 report) that could be closed inside the pipeline and the paper, without touching the Conclusion (work in progress) and without rebuilding the exposure crosswalk (deferred to its own plan).
...
**Objective:** Close the fourteen deductions in `docs/grade-reports/2026-09-23-seminar-grade-report.md` (86/100) inside the pipeline and the paper, without touching the Conclusion.
