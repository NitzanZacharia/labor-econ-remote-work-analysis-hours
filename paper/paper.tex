...
\renewcommand{\baselinestretch}{1}\small
\setlength{\tabcolsep}{4pt} % seven columns; the default 6pt overran the text width by ~15pt
...
it. The size is also what the most literal form of the time-constraint mechanism would produce:
