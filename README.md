...
| `scripts/hours_diagnostics.R` | `run_hours_diagnostics()` | The hours (primary) counterparts: 2×2 cell means of weekly hours and the hours event study. `main.R` wraps it in a `pdf()` device to produce `outputs/event_study_pretrend_hours.pdf`. |
